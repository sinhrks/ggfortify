...
In case the target only has single survival curve, you can specify some options to colorize the curve.  Use `help(autoplot.survfit)` (or `help(autoplot.*)` for any other objects) to check available options.
