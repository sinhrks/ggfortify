...
`ggfortify` supports `claster::clara`, `claster::fanny`, `claster::pam` classes. Because these instances should contains original data in its property, there is no need to pass original data explicitly.
