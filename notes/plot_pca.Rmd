...
PCA result should only contains numeric values. If you want to colorize by non-numeric values which original data has, pass original data using `original` keyword and then specify column name by `colour` keyword.
