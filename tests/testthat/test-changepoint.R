...
test_that('fortify.cpt works for AirPassengers', {
  ...
  expect_equal(fortified$Index[1], as.Date('1955-05-01'))
  expect_equal(fortified$Index[nrow(filtered)], as.Date('1960-12-01'))
  ...
  expect_equal(filtered$Index[1], as.Date('1955-04-01'))
  expect_equal(filtered$Index[nrow(filtered)], as.Date('1960-12-01'))
