...
**NOTE** Currently, ``ggfortify`` NEITHER support list of mixed instances and list of instances which has multiple classes.
...
Also, can draw multiple survival curves as subplots.
